...
app.use("/api/insumos", authMiddleware, requireRole(["solicitante", "guarda", "admin"]), insumosRoutes);
app.use("/api/lotes", authMiddleware, requireRole(["solicitante", "guarda", "almacen", "admin"]), lotesRoutes);
app.use("/api/movimientos", authMiddleware, requireRole(["solicitante", "guarda", "almacen", "admin"]), movimientosRoutes);
app.use("/api/solicitudes", authMiddleware, requireRole(["solicitante", "guarda", "almacen", "admin"]), solicitudesRoutes);
app.use(  "/api/stock",  authMiddleware,  requireRole(["solicitante", "guarda", "admin"]),  stockRoutes);
